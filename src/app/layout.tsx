      ...
      >
        <div className="bg-red-900 text-white text-center py-2 px-4 border-b-2 border-red-700">
          ...
          <p className="text-xs md:text-sm opacity-90">
            This site is satire for a private event at a private residence for our close friends who are personallyinvited to this event. If you stumbled upon this site, you are not invited and this is not for you. Not affiliated with any company or organization.
          </p>
        </div>
        <AuthProvider>
          {children}
