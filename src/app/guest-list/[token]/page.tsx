...
function categorizeCharacters(characters: Array<{ id: string; name: string; role: string }>) {
  const hosts: Array<{ id: string; name: string; role: string }> = [];
  const staff: Array<{ id: string; name: string; role: string }> = [];
  const guests: Array<{ id: string; name: string; role: string }> = [];
