...
const staticFaqs: FAQ[] = [
  {
    ...
    answer: " As the name suggests, this is a murder mystery party. You know, where someone pretends to be dead and you pretend to care enough to figure out who did it.Oh, you've never been to a murder mystery before? How quaint. Let us explain it like you're five: Someone gets 'murdered' (spoiler: it's fake, genius). Everyone has a character with secrets, motives, and backstories. You mingle, ask questions, lie through your teeth, and try to figure out who did it. Think of it as an interactive escape room combined with amateur theatre, except everyone's drunk and no one knows how to act. There will be clues, suspects, red herrings (that's a fake clue for you amateurs), and a reveal at the end where we all find out who the murderer is. If you're the kind of person who needs everything explained to them like a toddler, maybe just stay home and watch a detective show on Netflix instead.",
    order: 1,
    isActive: true
  },
  {
